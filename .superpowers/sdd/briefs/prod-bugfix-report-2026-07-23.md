...
| C3 | FIXED | Exactly one CPI is required, missing/non-executable targets fail, success event follows invoke; runtime tests added: `b13cacb`; `programs/supersonic-tx/src/lib.rs`, `tests/router_tests.rs` |
...
| I5 | FIXED | Every CLI sink/tip is RPC-proven system-owned and non-executable before type minting: `8e7fd10`; `noise.rs` |
...
| I9 | FIXED | Router count must equal the one executed CPI; event reports `routed_instruction_count`: `b13cacb` |
